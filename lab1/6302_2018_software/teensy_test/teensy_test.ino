...
unsigned int deltaT = 20000;         // Sample period in microseconds.
int angleAverages = 5;
...
//Rest of Setup:
bool first_time;
String config_message_30_bytes = "&A~DesiredAngV~5&C&S~Direct~O~0~5.0~0.1&S~Desired~A~0~5~0.1&S~Kp~P~0~30.0~0.1&T~AngleV~F4~-2.5~2.5&T~BackEMF~F4~0~5&T~MCmd~F4~0~5&H~4&";
...
void loop() {  // Main code, runs repeatedly
  ...
  float motorCmd = directV+Kp*(desiredV-motor_bemf);
