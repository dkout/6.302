...
const int16_t MOTOR_SPEED_LIMIT = 210;
...
// gains for +=
//const double DISTANCE_RESPONSE = .019;
//const double SPEED_RESPONSE = .85;
//const int16_t ANGLE_RESPONSE = 1;
//const double ANGLE_RATE_RESPONSE = .14;

//// pretty good:
//const double DISTANCE_RESPONSE = 0;
//const double SPEED_RESPONSE = 0;//.01;
//const int16_t ANGLE_RESPONSE = 25;//35;
//const double ANGLE_RATE_RESPONSE = 0;//3;

// pretty good:
const double DISTANCE_RESPONSE = 0.5;
const double SPEED_RESPONSE = 7.5; //.01;
const int16_t ANGLE_RESPONSE = 28; //35;
const double ANGLE_RATE_RESPONSE = .3;//3;

const double ENCODER_RATIO = 2*3.14*.04/2149;
const int16_t MOTOR_VOLTAGE_RATIO = 300.0/5.0;

// The balancing code is all based on a 100 Hz update rate; if
// you change this, you will have to adjust many other things.
const uint8_t UPDATE_TIME_MS = 30;
...
extern double angle; // units: millidegrees
extern double angleRate; // units: degrees/s (or millidegrees/ms)
